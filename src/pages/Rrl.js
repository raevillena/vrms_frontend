...
import { onGetDocumentation, onUpdateRrl } from "../services/studyAPI";
...
const Rrl = () => {
  ...
  useEffect(() => {
    async function getDataFromDB(){
      ...
      try{
        contentState = convertFromRaw(JSON.parse(result.data.docs.rrl))//displaying summary
      }catch(error){
        const dummy ={
        ...
        contentState = convertFromRaw(JSON.parse(dummy.resultsAndDiscussion))
      }
    ...
    try{
      ...
      console.log("error in the useEffect of results and discussion: ", error)
    }
